...
[![Snap Status](https://build.snapcraft.io/badge/YamiYukiSenpai/waterfox-current-snap.svg)](https://build.snapcraft.io/user/YamiYukiSenpai/waterfox-current-snap)
...
## Install
    ...
    sudo snap install --edge waterfox-current
